    ...
    <div class="wh-screen d-flex justify-content-center align-items-center bg-white font-nunito-sans">
        <div class="col-10" style="max-width: 480px">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="<?= base_url('recovery') ?>" class="text-primary ms-auto">Forgot password?</a>
            </div>
            <button class="btn btn-primary rounded-0" onclick="submitCredentials()"><i class="fa-solid fa-right-to-bracket"></i> Login</button>

            <p class="mt-3">Or <a href="<?= base_url('register') ?>">Create an account</a></p>
